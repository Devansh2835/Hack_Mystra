...
export default function HTMLCoursePage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#0b0015] via-[#120027] to-[#000010] text-white font-sans overflow-hidden">
      ...
      <div className="relative z-20">
        ...
        >
          ...
          >
            Learn the cosmic foundation of the web — build your universe with
            HTML.
          </motion.p>
        ...
        <div className="max-w-6xl mx-auto px-4 mb-10">
          <div className="flex flex-wrap gap-3 bg-slate-900/30 border border-indigo-500/30 rounded-xl p-4 backdrop-blur-xl justify-center">
            ...
            >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {section.topics.map((topic) => (
                  <motion.div
                    key={topic.id}
                    className={`relative bg-slate-900/40 border border-indigo-500/20 rounded-xl p-4 flex items-center justify-between transition-all cursor-pointer ${
                      topic.completed
                        ? "bg-gradient-to-r from-indigo-800/40 to-purple-800/40 border-purple-400/50"
                        : "hover:bg-slate-800/50 hover:border-indigo-400/40"
                    }`}
