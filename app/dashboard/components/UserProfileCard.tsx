    ...
    return (
        ...
        >
            <div className="text-center mb-6">
                ...
                <h2 className="text-xl font-bold text-white mb-1">Dipti</h2>
                <p className="text-sm text-purple-200/70 mb-3">Web3 Explorer</p>
                <Badge variant="secondary" className="bg-purple-900/50 text-purple-200 border-purple-700/50">
                    Level 1 Witch
                </Badge>
            </div>
            ...
            <div className="flex gap-2">
                ...
                <Button size="sm" variant="outline" className="border-purple-700/50 hover:bg-purple-900/30">
