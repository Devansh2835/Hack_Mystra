  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <motion.div
        ...
        animate="visible"
      >
        {/* Characters Container with enhanced animations */}
        <div className="mb-12 flex justify-center items-end gap-4 sm:gap-8 h-64 sm:h-80">
          ...
          >
            ...
            <p className="text-purple-300 text-xs sm:text-sm mt-3 font-bold tracking-wide">The Witch</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-pink-300 text-xs sm:text-sm mt-3 font-bold tracking-wide">Cyber Zombie</p>
          </motion.div>
          
          {/* Cyber Wizard - Hero Character - SAME AS WITCH */}
          <motion.div 
            className="flex flex-col items-center" 
            variants={itemVariants} 
            whileHover={{ 
          ...
          >
            ...
            <p className="text-purple-300 text-xs sm:text-sm mt-3 font-bold tracking-wide">Cyber Wizard</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-purple-300 text-xs sm:text-sm mt-3 font-bold tracking-wide">Tech Knight</p>
          </motion.div>
        </div>
        ...
        <motion.div variants={itemVariants} className="mb-10">
          <motion.h1 
            ...
            style={{
              background: "linear-gradient(90deg, #d8b4fe, #a78bfa, #22d3ee, #a78bfa, #d8b4fe)",
        ...
        >
          ...
          <motion.button
            ...
            whileHover={{ 
              scale: 1.05, 
              boxShadow: "0 0 40px rgba(168, 85, 247, 0.8), 0 20px 40px rgba(147, 51, 234, 0.4)"
            }}
            whileTap={{ scale: 0.95 }}
          >
          ...
          {/* Optional: Keep the auth button if needed */}
          {onAuthClick && (
            <motion.button
              onClick={onAuthClick}
